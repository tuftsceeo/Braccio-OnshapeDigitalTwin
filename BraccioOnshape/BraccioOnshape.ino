...
Onshape myclient("2iW6siSjTFkPDb94ZaImXXLC",
                 "yVG0lKNPpMrcvvmucdBJrZWwIncJu8hwpiHXfSbAuhucm1e3");
int cpNum = 0;
...
void setup() {
  ...
  //myclient.start("ARRIS-1ED2", "2SY99D600387");
  myclient.start("Tufts_Wireless");
